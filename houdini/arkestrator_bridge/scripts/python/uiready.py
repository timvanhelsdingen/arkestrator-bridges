"""Arkestrator Bridge interactive UI startup hook.

Runs once Houdini's UI is ready. This hook bootstraps the package path itself,
attempts immediate registration, and schedules a second registration on the Qt
event loop so GUI startup timing does not race the bridge connection.
"""
...
try:
    ...
    print(f"[ArkestratorBridge] scripts/python/uiready.py skipped: {exc}")
